...
public class OTable implements Table {
    ...
    public OTable(String name, String pathname, List<Class<?>> columnTypes) {
        ...
        allOStoreables = new TreeMap<String, Storeable>();
        sessionChanges = new TreeMap<String, Storeable>();
    ...
    public Storeable put(String key, Storeable value) {
        ...
        OStoreable s = (OStoreable) sessionChanges.put(key, value);
        if (s != null) {
            return s;
        } else {
    ...
    public Storeable remove(String key) {
        ...
        OStoreable s = (OStoreable) sessionChanges.remove(key);
        if (s != null) {
            unsavedChangesCounter++;
            numberOfElements--;
            return s;
    ...
    public int commit() throws IOException {
        ...
        allOStoreables = new TreeMap<>(sessionChanges);
    ...
    public void load() throws Exception {
        ...
        sessionChanges = new TreeMap<>(allOStoreables);
    }
     ...
     */
    public int rollback() {
        sessionChanges = new HashMap<>(allOStoreables);
        int n = unsavedChangesCounter;
        unsavedChangesCounter = 0;
    ...
    public Storeable get(String key) {
        ...
        OStoreable s = (OStoreable) sessionChanges.get(key);
        return s;
    }
